...
try:
    ...
    # Permanent Datasets
    outPoints = path.join(userWorkspace, f"{projectName}_XYZ_new_coordinates.shp")
    ...
    if sr.Type == 'Projected':
        ...
        AddMsgAndPrint(f"\tElevation Values (Z): {zUnits}") 
    ...
    CalculateField(pointsProj, 'POINT_Z', expression, 'PYTHON_9.3')
