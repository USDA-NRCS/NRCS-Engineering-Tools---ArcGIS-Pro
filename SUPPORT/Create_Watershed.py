...
try:
    ...
    dem_focal_stats = FocalStatistics(project_dem_path, 'RECTANGLE 3 3 CELL', 'MEAN', 'DATA')
    slope_grid = Slope(dem_focal_stats, 'PERCENT_RISE', 0.3048) # Z-factor Intl Feet to Meters
