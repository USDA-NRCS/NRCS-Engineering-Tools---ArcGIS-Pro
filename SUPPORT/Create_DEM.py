...
from arcpy import CheckExtension, CheckOutExtension, Describe, env, GetInstallInfo, GetParameterAsText, \
    SetParameter, SetProgressorLabel
from arcpy.analysis import Buffer
from arcpy.management import ApplySymbologyFromLayer, Clip, Compact, CopyRaster, Delete, MosaicToNewRaster, Project, ProjectRaster
