...
try:
    ...
    #TODO: convert xy to meters, so we have volume = meter*meter*meter
    ...
    AddMsgAndPrint('\n\tHighest closed contour is ' + str(hi_contour))
    ...
    CalculateField(pool_mask, 'DemElev', expression, 'PYTHON_9.3')
